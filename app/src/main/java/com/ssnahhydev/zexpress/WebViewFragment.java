...
public class WebViewFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        progressBar = mView.findViewById(R.id.pb_fragment);
        offLineRelativeLayout = mView.findViewById(R.id.rly_offline);

        wvMainWeb = mView.findViewById(R.id.main_webview);
        if(wvMainWeb != null){
//            wvMainWeb.getSettings().setAppCacheEnabled(false);
//            wvMainWeb.getSettings().setCacheMode(WebSettings.LOAD_NO_CACHE);

            //for disabling the scrolling
//            wvMainWeb.setOnTouchListener(new View.OnTouchListener(){
//                @Override
...
//            });
            ...
            wvMainWeb.setWebViewClient(new WebViewClient() {
                ...
                public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                    ...
                    wvMainWeb.setVisibility(View.GONE);
                ...
                public boolean shouldOverrideUrlLoading(WebView view, String url) {
                    ...
                    if(Uri.parse(url).getHost() != null){
                        if (Uri.parse(url).getHost().equals(Uri.parse(mUrl).getHost())) {
                            ...
                            intent.putExtra(WebViewActivity.WEB_TITLE_INTENT, "ZedExpress");
